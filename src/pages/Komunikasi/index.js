...
<View>
    ...
    <Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>1. Guru memberikan kesempatan kepada beberapa kelompok untuk membacakan hasil karyanya di depan kelas dengan cara:{'\n'}
• Kelompok yang sudah siap untuk membacakan hasil karya mereka di depan kelas akan  akan melontarkan yel-yel penyemangat kelompoknya, sebagai tanda bahwa kelompok tersebut siap untuk membacakan hasil karya mereka.{'\n'}
...
<Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>2. Kelompok yang tidak sedang presentasi atau maju membacakan hasil karyanya diwajibkan untuk memperhatikan dan menulis hal-hal yang dijadikan saran atau masukan, yang kemudian akan dibahas atau dijadijadikan bahan untuk refleksi pada tahap atau langkah berikutnya yakni tahap evaluasi.
</Text>
</View>
<MyGap jarak={20} />
         </View>
