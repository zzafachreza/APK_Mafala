...
export default function Home({ navigation, route }) {
  ...
  <View style={{padding:10}}>
    ...
    <View style={{flexDirection:'row',padding:10 , justifyContent:'space-between'}}>
      <View>
        <Text style={{fontFamily:fonts.primary[600], color:colors.tertiary, fontSize:12,}}>Selamat datang!</Text>
        <Text style={{fontFamily:fonts.primary[600], color:colors.tertiary, fontSize:20,}}>Aplikasi Ma’Fala</Text>
      </View>
      ...
      {/*MAIN CONTENT */}
    <View style={{padding:10, top:-13}}>

        {/* LANGKAH PERTAMA */}
      <TouchableNativeFeedback onPress={() => navigation.navigate('Orientasi')}>
        <View style={{padding:10, borderWidth:1, borderRadius:20, borderColor:colors.tertiary,
          flexDirection:"row", justifyContent:'space-between', backgroundColor:'white'

        }}>
          <View style={{justifyContent:'center'}}>
            <Text style={{fontFamily:fonts.primary[400], fontSize:10}}>Langkah Pertama</Text>
            <Text  style={{fontFamily:fonts.primary[600], fontSize:25, color:colors.tertiary}}>Orientasi</Text>
          </View>

          <View>
            <Image source={require('../../assets/orientasi.png')} style={{
              width:93, height:93
            }}/>
          </View>
        </View>
      ...
      <TouchableNativeFeedback onPress={() => navigation.navigate('Jelajahi')}>
        <View style={{padding:10, borderWidth:1, borderRadius:20, borderColor:colors.tertiary,
          ...
          <View style={{justifyContent:'center'}}>
            <Text style={{fontFamily:fonts.primary[400], fontSize:10}}>Langkah Kedua</Text>
            <Text  style={{fontFamily:fonts.primary[600], fontSize:25, color:colors.tertiary}}>Jelajahi</Text>
          </View>

          <View>
            <Image source={require('../../assets/jelajahi.png')} style={{
              width:91, height:91
            }}/>
          </View>
        </View>
      ...
      <MyGap jarak={15}/>
          ...
          <TouchableNativeFeedback onPress={() => navigation.navigate('Eksplorasi')}>
            <View style={{padding:10, borderWidth:1, borderRadius:20, borderColor:colors.tertiary,
              ...
              <View style={{justifyContent:'center'}}>
                <Text style={{fontFamily:fonts.primary[400], fontSize:10, top:5}}>Langkah Ketiga</Text>
                <Text  style={{fontFamily:fonts.primary[600], fontSize:25, color:colors.tertiary}}>Eksplorasi &{'\n'}
                Kreasi</Text>
              </View>
    
              <View>
                <Image source={require('../../assets/eksplorasi.png')} style={{
                  width:92, height:92
                }}/>
              </View>
            </View>
          ...
          <TouchableNativeFeedback onPress={() => navigation.navigate('Komunikasi')}>
            <View style={{padding:10, borderWidth:1, borderRadius:20, borderColor:colors.tertiary,
              ...
              <View style={{justifyContent:'center'}}>
                <Text style={{fontFamily:fonts.primary[400], fontSize:10}}>Langkah Keempat</Text>
                <Text  style={{fontFamily:fonts.primary[600], fontSize:25, color:colors.tertiary}}>Komunikasi</Text>
              </View>
    
              <View style={{justifyContent:'center', top:5}}>
                <Image source={require('../../assets/komunikasi.png')} style={{
                  width:91, height:91
                }}/>
              </View>
            </View>
          ...
          <TouchableNativeFeedback onPress={() => navigation.navigate('Evaluasi')}>
            <View style={{padding:10, borderWidth:1, borderRadius:20, borderColor:colors.tertiary,
              ...
              <View style={{justifyContent:'center'}}>
                <Text style={{fontFamily:fonts.primary[400], fontSize:10}}>Langkah Kelima</Text>
                <Text  style={{fontFamily:fonts.primary[600], fontSize:25, color:colors.tertiary}}>Evaluasi</Text>
              </View>
    
              <View>
                <Image source={require('../../assets/evaluasi.png')} style={{
                  width:93, height:93
                }}/>
              </View>
            </View>
