 ...
 <View style={{alignSelf:'center', justifyContent:"center", left:20}}>
    ...
    <View style={{padding:10,}}>
         ...
         <View style={{padding:10, }}>
            ...
            <Text style={{fontFamily:fonts.primary[600], }}>Ayo... Menciptakan sebuah puisi dengan mengadaptasikan unsur yang terdapat dalam dolabololo</Text>
                <MyGap jarak={20}/>
            <Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>Yuukk… Ikuti langkah-langkah dibawah ini ya…!</Text>
            <MyGap jarak={5}/>
            <Text style={{fontFamily:fonts.primary[400], fontSize:11, }}>1. Langkah pertama adalah belajar Menciptakan imajinasi.{'\n'}
            ...
            <MyGap jarak={10}/>
            <Text style={{fontFamily:fonts.primary[400], fontSize:11, }}>
            2. Langkah kedua setelah Setelah menciptakan imajinasi{'\n'}adalah <Text style={{fontWeight:'bold'}}> membangun ide atau gagasan.  </Text> guru mengajak{'\n'}siswa menjadikan Tema yang telah ditemukan dalam dolabololo pada kegiatan sebelumn ya, sebagai titik fokus siswa menumpahkan kosa kata imajinatif mereka. Terutama judul yang diciptakan dari puisi tersebut haruslah menggambarkan tema dari dolabololo tersebut. 
            </Text>
            <MyGap jarak={10}/>
            <Text style={{fontFamily:fonts.primary[400], fontSize:11, }}>Contoh proses membangun ide atau gagasan dengan memanfaatkan dolabololo :</Text>
