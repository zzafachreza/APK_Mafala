...
<View>
    <Text style={{fontSize:12, fontFamily:fonts.primary[600], textAlign:'left'}}>
    Ayooo.. menilai hasil karya puisi yang telah dihasilkan serta merefleksi pembelajaran yang telah berlangsung.
    </Text>

    <MyGap jarak={10}/>
    <Text style={{fontSize:12, fontFamily:fonts.primary[400], }}>Yuukk… Ikuti langkah-langkah dibawah ini ya…!</Text>
    <Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>1. Seluruh anggota kelompok mengumpulkan hasil karya mereka kepada guru.</Text>
    <Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>2. Masing-masing anggota kelompok yang tidak mendapatkan kesempatan untuk mempresentasikan atau membacakan hasil karyanya di depan, diwajibkan untuk menyampaikan komentar mereka terhadap hasil karya kelompok lain yang telah dipersentasikan di depan kelas sebelumnya. Komentar tersebut berupa masukan dan saran tentang penggunaan diksi, gaya bahasa, bunyi, pesan ataupun makna yang terdapat dalam puisi tersebut.</Text>
    <Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>3. Guru juga memberikan komentar berupa masukan dan saran tentang penggunaan diksi, gaya bahasa, bunyi, pesan ataupun makna  terhadap hasil karya siswa yang telah dipresentasikan di depan kelas.</Text>
    <Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>4. Siswa dan guru sama-sama merefleksi proses pembelajaran yang telah berlangsung.</Text>
    <Text style={{fontFamily:fonts.primary[400], fontSize:12, }}>5. Hasil karya puisi siswa yang telah dikumpulkan akan dinilai oleh guru dengan menggunakan pedoman penskoran hasil karya puisi siswa.</Text>
